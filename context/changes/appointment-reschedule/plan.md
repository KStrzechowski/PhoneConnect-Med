...
- [x] 3.1 Speech Lambda unit tests pass (new `RescheduleIntent` coverage) — 3df82a6
- [x] 3.2 `cdk synth` succeeds with the new Lex intent — 3df82a6
- [x] 3.3 Type checking and linting pass — 3df82a6
